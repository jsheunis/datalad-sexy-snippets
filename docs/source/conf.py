# -*- coding: utf-8 -*-
#
# datalad_sexy_snippets documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_sexy_snippets:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_sexy_snippets.__version__
release = version
